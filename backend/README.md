...
## Project Structure
    ...
    ├── testapiautodatamod_111447  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_111447`
...
2. Clone this repo and `cd testapiautodatamod_111447`
